...
public class ExampleStreaming1 : MonoBehaviour
{
    ...
    //Creating Vincent Controller object
        ...
        if (result != null && result.results.Length > 0)
        {
            foreach (var res in result.results)
            {
                foreach (var alt in res.alternatives)
                {
                    ...
                    //Transporting text data to VincetAction Commands
                    if(res.final){
                        VincentControllerObj.VincentActions(alt.transcript);
                    }
                }
